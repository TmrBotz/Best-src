...
async def token_handler(client, message):
    ...
    if len(message.command) <= 1:
        image_url = "https://envs.sh/imw.jpg"
        join_button = InlineKeyboardButton("Join Channel", url="https://t.me/Zero_Botz")
        premium = InlineKeyboardButton("Buy Premium", url="http://t.me/Connecting_iBot")   
